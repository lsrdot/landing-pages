...
function App() {
  ...
  return (
    <>
      <input id="close-menu" className="close-menu" type="checkbox" ariaLabel="Close menu" role="button" />
        ...
        <div className="main-content grid-one-content">
          ...
          <div className="grid">
            <div className="gallery-img">
              <img className="random-img" src="https://image.msar.me/unsplash/photos/random?type=image"/>
            </div>
            <div className="gallery-img">
              <img className="random-img" src="https://image.msar.me/unsplash/photos/random?type=image"/>
            </div>
      ...
      <footer id="footer" className="footer white-bg">
        <p><a rel="nofollow" target="_blank" href="https://github.com/lsrdot">Follow me on GitHub!</a></p>
      </footer>
